    ...
    menuItems: [
      {
        ...
        label: 'Colecciones Personales',
        route: '#',
        children: [
          { label: 'Lista de Colecciones', route: '/colecciones' },
          { label: 'Registrar Nueva Colección', route: '/colecciones/registrar' }
        ]
      },
      {
        icon: `<svg
    ...
    menuItems: [
      {
        ...
        label: 'Libros',
        route: '#',
        children: [{ label: 'Registrar Nuevo Libro', route: '/libros/registrar' }]
      }
    ]
  }
])
